    ...
    public void doDraw(Canvas canvas) {
        ...
        for (int x = 0; x < state.width; x++) {
            for (int y = 0; y < state.height; y++) {
                ...
                canvas.drawRect(state.blockSizeX * x, state.blockSizeY * y, state.blockSizeX - 1
                        + state.blockSizeX * x, state.blockSizeY - 1 + state.blockSizeY * y, paint);
            }
        }
        ...
        //canvas.drawText("rotate:"+state.action_rotate+"x:"+((int) state.touchX/
        // state.blockSizeX)+"y:"+((int) state.touchY/ state.blockSizeY), 10, position+30, paint);
